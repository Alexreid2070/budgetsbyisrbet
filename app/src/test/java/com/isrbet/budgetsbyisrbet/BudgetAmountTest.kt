...
class GetBudgetAmountTest {
    ...
    fun budgetAmountTest() {
        ...
        BudgetViewModel.updateBudget(1001, MyDate("2022-01-01"), 2, 100.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget(1003, MyDate("2022-01-01"), 2, 210.0, cPeriodMonth, 0, cBUDGET_JUST_THIS_MONTH, true)
        BudgetViewModel.updateBudget(1004, MyDate("2022-01-01"), 0, 5.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget(1005, MyDate("2022-01-01"), 0, 10.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget(1005, MyDate("2022-01-01"), 1, 10.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 1*100, 1005, "test", "", 1, 1, 0, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 2*100, 1005, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 4*100, 1004, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 4*100, 1005, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 100*100, 1003, "test", "", 2, 2, 50, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-03-15", 100*100, 1003, "test", "", 2, 2, 20, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-03-15", 7*100, 1005, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-04-15", 4*100, 1005, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 100*100, -99, "transfer", "", 1, 2, 0, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 100*100, -99, "transfer", "", 2, 1, 100, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 100*100, -99, "transfer", "", 1, 2, 0, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 100*100, -99, "transfer", "", 2, 1, 100, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-03-15", 100*100, -99, "transfer", "", 1, 2, 0, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-03-15", 100*100, -99, "transfer", "", 2, 1, 100, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-04-15", 100*100, -99, "transfer", "", 1, 2, 0, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-04-15", 100*100, -99, "transfer", "", 2, 1, 100, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-05-15", 100*100, -99, "transfer", "", 1, 2, 0, "Transfer"), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-05-15", 100*100, -99, "transfer", "", 2, 1, 100, "Transfer"), true)

        var ac = TransactionViewModel.getActualsForPeriod(1004, MyDate(2022,1,1), MyDate(2022,1,1), 0, true)
        ...
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, MyDate(2022,1,1), MyDate(2022,2,1), 0, true)
        ...
        Assert.assertEquals(0, bm.startDate.month)
        Assert.assertEquals(1, bm.applicableDate.month)
        ...
        Assert.assertEquals(10.0, bm.amount, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-01-01"), 1005, 0)
        Assert.assertEquals(2.0, bmr, 0.0)
        ...
        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-01-01"), 0)
        Assert.assertEquals(0.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-01-01"), 0)
        Assert.assertEquals(0.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-01-01"), 1001, 0)
        Assert.assertEquals(50.0, bmr, 0.0)
        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-01-01"), 1)
        Assert.assertEquals(0.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-01-01"), 1)
        Assert.assertEquals(0.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-01-01"), 1001, 1)
        Assert.assertEquals(50.0, bmr, 0.0)
        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-01-01"), 2)
        Assert.assertEquals(100.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-01-01"), 2)
        Assert.assertEquals(100.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-01-01"), 1001, 2)
        Assert.assertEquals(100.0, bmr, 0.0)

        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-02-01"), 0)
        Assert.assertEquals(0.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-02-01"), 0)
        Assert.assertEquals(0.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-02-01"), 1001, 0)
        Assert.assertEquals(50.0, bmr, 0.0)
        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-02-01"), 1)
        Assert.assertEquals(0.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-02-01"), 1)
        Assert.assertEquals(0.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-02-01"), 1001, 1)
        Assert.assertEquals(50.0, bmr, 0.0)
        bm = BudgetViewModel.getOriginalBudgetAmount(1001, MyDate("2022-02-01"), 2)
        Assert.assertEquals(100.0, bm.amount, 0.0)
        bm2 = BudgetViewModel.budgetExistsForExactPeriod(1001, MyDate("2022-02-01"), 2)
        Assert.assertEquals(0.0, bm2, 0.0)
        bmr = BudgetViewModel.getCalculatedBudgetAmount(MyDate("2022-02-01"), 1001, 2)
        Assert.assertEquals(100.0, bmr, 0.0)
        ...
        BudgetViewModel.updateBudget(1006, MyDate("2022-01-01"),2, 100.0, cPeriodMonth, 1, cBUDGET_RECURRING, true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 5*100, 1006, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-01-15", 6*100, 1006, "test", "", 1, 1, 0, ""), true)
        ...
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 100*100, 1006, "test", "", 0, 0, 100, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-02-15", 50*100, 1006, "test", "", 1, 1, 0, ""), true)
        ...
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-03-15", 25*100, 1005, "test", "", 2, 2, 50, ""), true)
        TransactionViewModel.addTransactionLocal(TransactionOut("2022-04-15", 140*100, 1005, "test", "", 2, 2, 50, ""), true)
