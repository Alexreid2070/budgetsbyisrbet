...
class GetBudgetAmountTest {
    ...
    fun budgetAmountTest() {
        ...
        BudgetViewModel.updateBudget("A", 1002, MyDate("2022-01-01"), 2, 100.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget("B", 1003, MyDate("2022-01-01"), 2, 210.0, cPeriodMonth, 0, cBUDGET_JUST_THIS_MONTH, true)
        BudgetViewModel.updateBudget("C", 1004, MyDate("2022-01-01"), 0, 5.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget("D", 1005, MyDate("2022-01-01"), 0, 10.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        BudgetViewModel.updateBudget("E", 1005, MyDate("2022-01-01"), 1, 10.0, cPeriodMonth, 0, cBUDGET_RECURRING, true)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 100.0, 1003, "test", "", 2, 2, cTRANSACTION_TYPE_EXPENSE, 50, "A"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-03-15", 100.0, 1003, "test", "", 2, 2, cTRANSACTION_TYPE_EXPENSE, 20, "B"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 4.0, 1004, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "C"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 1.0, 1005, "test", "", 1, 1, cTRANSACTION_TYPE_EXPENSE, 0, "D"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 2.0, 1005, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "E"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 4.0, 1005, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "F"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-03-15", 7.0, 1005, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "G"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-04-15", 4.0, 1005, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "H"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 100.0, -99, "transfer", "", 1, 2, cTRANSACTION_TYPE_EXPENSE, 0, "TransferA"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 100.0, -99, "transfer", "", 2, 1, cTRANSACTION_TYPE_EXPENSE, 100, "TransferB"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 100.0, -99, "transfer", "", 1, 2, cTRANSACTION_TYPE_EXPENSE, 0, "TransferC"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 100.0, -99, "transfer", "", 2, 1, cTRANSACTION_TYPE_EXPENSE, 100, "TransferD"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-03-15", 100.0, -99, "transfer", "", 1, 2, cTRANSACTION_TYPE_EXPENSE, 0, "TransferE"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-03-15", 100.0, -99, "transfer", "", 2, 1, cTRANSACTION_TYPE_EXPENSE, 100, "TransferF"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-04-15", 100.0, -99, "transfer", "", 1, 2, cTRANSACTION_TYPE_EXPENSE, 0, "TransferG"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-04-15", 100.0, -99, "transfer", "", 2, 1, cTRANSACTION_TYPE_EXPENSE, 100, "TransferH"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-05-15", 100.0, -99, "transfer", "", 1, 2, cTRANSACTION_TYPE_EXPENSE, 0, "TransferI"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-05-15", 100.0, -99, "transfer", "", 2, 1, cTRANSACTION_TYPE_EXPENSE, 100, "TransferJ"), false)
        ...
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 5.0, 1006, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "AA"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-01-15", 6.0, 1006, "test", "", 1, 1, cTRANSACTION_TYPE_EXPENSE, 0, "AB"), false)
        ...
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 100.0,1006, "test", "", 0, 0, cTRANSACTION_TYPE_EXPENSE, 100, "AC"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-02-15", 50.0, 1006, "test", "", 1, 1, cTRANSACTION_TYPE_EXPENSE, 0, "AD"), false)
        ...
        TransactionViewModel.addTransactionLocal(Transaction("2022-03-15", 25.0, 1005, "test", "", 2, 2, cTRANSACTION_TYPE_EXPENSE, 50, "AE"), false)
        TransactionViewModel.addTransactionLocal(Transaction("2022-04-15", 140.0, 1005, "test", "", 2, 2, cTRANSACTION_TYPE_EXPENSE, 50, "AF"), false)
