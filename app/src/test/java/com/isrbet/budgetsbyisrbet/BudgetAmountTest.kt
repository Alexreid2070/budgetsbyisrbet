...
class GetBudgetAmountTest {
    ...
    fun budgetAmountTest() {
        ...
        CategoryViewModel.updateCategory(0, "Housing", "Mortgage", cDiscTypeNondiscretionary, 2, true)
        CategoryViewModel.updateCategory(0, "Housing", "Property Taxes", cDiscTypeNondiscretionary, 2, true)
        CategoryViewModel.updateCategory(0, "Housing", "Renos", cDiscTypeNondiscretionary, 2, true)
        CategoryViewModel.updateCategory(0, "Life", "Booze", cDiscTypeDiscretionary, 2, true)
        CategoryViewModel.updateCategory(0, "Life", "Annual", cDiscTypeDiscretionary, 2, true)
        ...
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-01-15", 100*100, -99, "transfer", 1, 2, 0, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-01-15", 100*100, -99, "transfer", 2, 1, 100, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-02-15", 100*100, -99, "transfer", 1, 2, 0, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-02-15", 100*100, -99, "transfer", 2, 1, 100, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-03-15", 100*100, -99, "transfer", 1, 2, 0, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-03-15", 100*100, -99, "transfer", 2, 1, 100, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-04-15", 100*100, -99, "transfer", 1, 2, 0, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-04-15", 100*100, -99, "transfer", 2, 1, 100, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-05-15", 100*100, -99, "transfer", 1, 2, 0, "Transfer"), true)
        ExpenditureViewModel.addTransaction(ExpenditureOut("2022-05-15", 100*100, -99, "transfer", 2, 1, 100, "Transfer"), true)
        ...
        var totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeDiscretionary, 0)
        var totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeDiscretionary, 0)
        Assert.assertEquals(2.0, totAc, 0.0)
        Assert.assertEquals(7.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeDiscretionary, 1)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeDiscretionary, 1)
        Assert.assertEquals(1.0, totAc, 0.0)
        Assert.assertEquals(1.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeDiscretionary, 2)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeDiscretionary, 2)
        Assert.assertEquals(3.0, totAc, 0.0)
        Assert.assertEquals(8.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1), cDiscTypeNondiscretionary, 0)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeNondiscretionary, 0)
        Assert.assertEquals(0.0, totAc, 0.0)
        Assert.assertEquals(50.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeNondiscretionary, 1)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeNondiscretionary, 1)
        Assert.assertEquals(0.0, totAc, 0.0)
        Assert.assertEquals(50.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeNondiscretionary, 2)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeNondiscretionary, 2)
        Assert.assertEquals(0.0, totAc, 0.0)
        Assert.assertEquals(100.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1), cDiscTypeAll, 0)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeAll, 0)
        Assert.assertEquals(2.0, totAc, 0.0)
        Assert.assertEquals(57.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeAll, 1)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeAll, 1)
        Assert.assertEquals(1.0, totAc, 0.0)
        Assert.assertEquals(51.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,1),cDiscTypeAll, 2)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,1), cDiscTypeAll, 2)
        Assert.assertEquals(3.0, totAc, 0.0)
        Assert.assertEquals(108.0, totBu, 0.0)

        totBu = BudgetViewModel.getTotalCalculatedBudgetForMonth(BudgetMonth(2022,2),cDiscTypeDiscretionary, 0)
        totAc = ExpenditureViewModel.getTotalActualsToDate(BudgetMonth(2022,2), cDiscTypeDiscretionary, 0)
        ...
        bmr = BudgetViewModel.getTotalCalculatedBudgetForMonthForCategory(1003, BudgetMonth("2022-03"), cDiscTypeAll, 0)
        Assert.assertEquals(20.0, bmr, 0.0)
        bmr = BudgetViewModel.getTotalCalculatedBudgetForMonthForCategory(1003, BudgetMonth("2022-03"), cDiscTypeAll, 1)
        Assert.assertEquals(80.0, bmr, 0.0)
        bmr = BudgetViewModel.getTotalCalculatedBudgetForMonthForCategory(1003, BudgetMonth("2022-03"), cDiscTypeAll, 2)
        Assert.assertEquals(100.0, bmr, 0.0)
    }
}