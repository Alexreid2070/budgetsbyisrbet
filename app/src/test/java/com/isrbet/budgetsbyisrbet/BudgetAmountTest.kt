...
class GetBudgetAmountTest {
    ...
    fun budgetAmountTest() {
        ...
        var ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,1), 0)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,1), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,1), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,2), 0)
        Assert.assertEquals(4.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,2), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1004, BudgetMonth(2022,1), BudgetMonth(2022,2), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,1), BudgetMonth(2022,1), 0)
        Assert.assertEquals(2.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,1), BudgetMonth(2022,1), 1)
        Assert.assertEquals(1.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,1), BudgetMonth(2022,1), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,2), 0)
        Assert.assertEquals(4.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,2), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,2), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,3), BudgetMonth(2022,3), 0)
        Assert.assertEquals(7.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,3), BudgetMonth(2022,3), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,3), BudgetMonth(2022,3), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,4), BudgetMonth(2022,4), 0)
        Assert.assertEquals(4.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,4), BudgetMonth(2022,4), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,4), BudgetMonth(2022,4), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,3), 0)
        Assert.assertEquals(11.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,3), 1)
        Assert.assertEquals(0.0, ac, 0.0)
        ac = TransactionViewModel.getActualsForPeriod(1005, BudgetMonth(2022,2), BudgetMonth(2022,3), 2)
        Assert.assertEquals(0.0, ac, 0.0)
        ...
        var totAc = TransactionViewModel.getTotalActualsForRange("2022-01", "2022-01",
        ...
        totAc = TransactionViewModel.getTotalActualsForRange("2022-01", "2022-01",
        ...
        totAc = TransactionViewModel.getTotalActualsForRange("2022-02", "2022-02",
            cDiscTypeDiscretionary, 0)
