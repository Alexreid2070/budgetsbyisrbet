...
class ExampleInstrumentedTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.isrbet.budgetsbyisrbet", appContext.packageName)
    }
...
//        defModel.clearCallback()
        ...
        CategoryViewModel.updateCategory(0, "Housing", "Mortgage", cDiscTypeNondiscretionary, 2, true,true, false, false, MyDate(), MyDate())
        CategoryViewModel.updateCategory(0, "Housing", "Property Taxes", cDiscTypeNondiscretionary, 2, true, true, false, false, MyDate(), MyDate())
        CategoryViewModel.updateCategory(0, "Housing", "Renos", cDiscTypeNondiscretionary, 2, true, true, false, false, MyDate(), MyDate())
        CategoryViewModel.updateCategory(0, "Life", "Booze", cDiscTypeDiscretionary, 2, true, true, false, false, MyDate(), MyDate())
        CategoryViewModel.updateCategory(0, "Life", "Annual", cDiscTypeDiscretionary, 2, true, true, false, false, MyDate(), MyDate())
        ...
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 1.0, 1005, "test", "", 1, 1, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 2.0, 1005, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 100.0, 1003, "test", "", 2, 2, 50, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 4.0, 1004, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 4.0, 1005, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-03-15"), 100.0, 1003, "test", "", 2, 2, 20, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-03-15"), 7.0, 1005, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-04-15"), 4.0, 1005, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 100.0, -99, "transfer", "", 1, 2, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 100.0, -99, "transfer", "", 2, 1, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 100.0, -99, "transfer", "", 1, 2, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 100.0, -99, "transfer", "", 2, 1, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-03-15"), 100.0, -99, "transfer", "", 1, 2, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-03-15"), 100.0, -99, "transfer", "", 2, 1, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-04-15"), 100.0, -99, "transfer", "", 1, 2, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-04-15"), 100.0, -99, "transfer", "", 2, 1, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-05-15"), 100.0, -99, "transfer", "", 1, 2, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-05-15"), 100.0, -99, "transfer", "", 2, 1, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        ...
        CategoryViewModel.updateCategory(0, "Life", "JointBudgetIndependentActuals", cDiscTypeDiscretionary, 2, true, true, false, false, MyDate(), MyDate())
        BudgetViewModel.updateBudget("F", 1006, MyDate("2022-01-01"),2, 100.0, cPeriodMonth, 1, cBUDGET_RECURRING, true)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 5.0, 1006, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-01-15"), 6.0, 1006, "test", "", 1, 1, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        ...
        Assert.assertEquals(11.0, bmr, 0.0)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 100.0,1006, "test", "", 0, 0, 100, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-02-15"), 50.0, 1006, "test", "", 1, 1, 0, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        ...
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-03-15"), 25.0, 1005, "test", "", 2, 2, 50, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
        TransactionViewModel.addTransactionLocal(Transaction(MyDate("2022-04-15"), 140.0, 1005, "test", "", 2, 2, 50, cTRANSACTION_TYPE_EXPENSE, "", "", MyDate()), false)
