...
//        defModel.clearCallback()
        ...
        CategoryViewModel.updateCategory(0, "Housing", "Mortgage", cDiscTypeNondiscretionary, 2, true,true, false)
        CategoryViewModel.updateCategory(0, "Housing", "Property Taxes", cDiscTypeNondiscretionary, 2, true, true, false)
        CategoryViewModel.updateCategory(0, "Housing", "Renos", cDiscTypeNondiscretionary, 2, true, true, false)
        CategoryViewModel.updateCategory(0, "Life", "Booze", cDiscTypeDiscretionary, 2, true, true, false)
        CategoryViewModel.updateCategory(0, "Life", "Annual", cDiscTypeDiscretionary, 2, true, true, false)
        ...
        CategoryViewModel.updateCategory(0, "Life", "JointBudgetIndependentActuals", cDiscTypeDiscretionary, 2, true, true, false)
